...
public class BuildInfo {
    ...
    public static final String[] sdk_version = {"4.0", "4.0.3", "4.1.1", "4.1.2", "4.2.2", "4.3.1", "4.4.2", "4.4.4",
            "5.0.1", "5.1.1", "5.1.1", "6.0", "6.0.1", "7.0", "7.1", "7.1.1"};
    ...
    private int getSDKAPI() {
        return getSDKAPI(version);
    }

    public static int getSDKAPI(String version) {
        switch (version) {
            case "4.0":
                return 14;
            case "4.0.3":
    ...
    public static String getSDKVersion(int api) {
        switch (api) {
            case 14:
                return "4.0";
            case 15:
                return "4.0.3";
            case 16:
                return new Random().nextInt(2) == 0 ? "4.1.2" : "4.1.1";
            case 17:
                return "4.2.1";
            case 18:
                return "4.3.1";
            case 19:
                return new Random().nextInt(2) == 0 ? "4.4.2" : "4.4.4";
            case 20:
                return "4.4W";
            case 21:
                return new Random().nextInt(2) == 0 ? "5.0.1" : "5.0.2";
            case 22:
                return new Random().nextInt(2) == 0 ? "5.1.2" : "5.1.1";
            case 23:
                return new Random().nextInt(2) == 0 ? "6.0" : "6.0.1";
            case 24:
                return new Random().nextInt(2) == 0 ? "7.0" : "7.1.1";
        }
        return "4.0.3";
    }
