...
public class InstanceStoreModel extends BaseModel {
    private final IHttpCallback callback;
    private InstanceStoreInfo data;

    public InstanceStoreModel(IHttpCallback callback, InstanceStoreInfo data) {
    ...
    public HttpEntry toHttpEntry() {
        ...
        httpEntry.setBaseUrl("add_instance_store_info.php");
        return httpEntry;
    }
